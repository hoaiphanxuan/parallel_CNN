#include "./conv_gpu_optimize_0.h"
#include <math.h>
#include <iostream>


void Conv_GPU_Optimize_0::init()
{
...
void Conv_GPU_Optimize_0::forward(const Matrix &bottom)
{
    ...
    Forward_GPU::forward_GPU_optimize_0(output, input, w, b,
...
std::vector<float> Conv_GPU_Optimize_0::get_parameters() const
{
...
void Conv_GPU_Optimize_0::set_parameters(const std::vector<float> &param)
{
