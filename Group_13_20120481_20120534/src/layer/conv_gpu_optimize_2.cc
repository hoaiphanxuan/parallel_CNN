#include "./conv_gpu_optimize_2.h"
#include <math.h>
#include <iostream>


void Conv_GPU_Optimize_2::init()
{
...
void Conv_GPU_Optimize_2::forward(const Matrix &bottom)
{
    ...
    Forward_GPU::forward_GPU_optimize_2(output, input, w, b,
...
std::vector<float> Conv_GPU_Optimize_2::get_parameters() const
{
...
void Conv_GPU_Optimize_2::set_parameters(const std::vector<float> &param)
{
