#include "./conv_gpu_optimize_3.h"
#include <math.h>
#include <iostream>


void Conv_GPU_Optimize_3::init()
{
...
void Conv_GPU_Optimize_3::forward(const Matrix &bottom)
{
    ...
    Forward_GPU::forward_GPU_optimize_3(output, input, w, b,
...
std::vector<float> Conv_GPU_Optimize_3::get_parameters() const
{
...
void Conv_GPU_Optimize_3::set_parameters(const std::vector<float> &param)
{
