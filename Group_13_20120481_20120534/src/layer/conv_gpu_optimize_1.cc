#include "./conv_gpu_optimize_1.h"
#include <math.h>
#include <iostream>


void Conv_GPU_Optimize_1::init()
{
...
void Conv_GPU_Optimize_1::forward(const Matrix &bottom)
{
    ...
    Forward_GPU::forward_GPU_optimize_1(output, input, w, b,
...
std::vector<float> Conv_GPU_Optimize_1::get_parameters() const
{
...
void Conv_GPU_Optimize_1::set_parameters(const std::vector<float> &param)
{
