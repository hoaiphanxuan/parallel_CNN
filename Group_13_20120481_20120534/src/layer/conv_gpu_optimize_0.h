...
#include <vector>
#include "../layer.h"
#include "../gpu_src/gpu_utils.h"
#include "../gpu_src/gpu_forward.h"


class Conv_GPU_Optimize_0 : public Layer
{
private:
   const int dim_in;
  int dim_out;
...
public:
    Conv_GPU_Optimize_0(int channel_in, int height_in, int width_in, int channel_out,
